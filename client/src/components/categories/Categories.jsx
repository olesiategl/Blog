                  ...
                  <div className={classes.blogData}>
                    <div className={classes.categoryAndMetadata}>
                      ...
                      <div className={classes.metadata}>
                        <MdOutlinePreview /> {blog.views} переглядів
                      </div>
                      <div className={classes.metadata}>
                        <AiFillLike /> {blog?.likes?.length} вподобань
                      </div>
                    </div>
                    <h4>{blog?.title}</h4>
                    ...
                    <div className={classes.authorAndCreatedAt}>
                      ...
                      <span><span>Створено:</span> {format(blog?.createdAt)}</span>
                    </div>
                    <Link to={`/blogDetails/${blog._id}`} className={classes.readMore}>
                      Детальніше <FiArrowRight />
                    </Link>
                  </div>
                </div>
              ))}
            </div>
            : <h3 className={classes.noBlogsMessage}>Немає постів</h3>}
        </div>
      </div>
    </div>
  )
